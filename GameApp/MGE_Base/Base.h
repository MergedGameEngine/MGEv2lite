...
public:
	...
	BOOL32 Add(const char *_str, const MGEObject *obj);
	const MGEObject *Get(const char *_str);
	BOOL32 Set(const char *_str, const MGEObject *obj);
	BOOL32 Del(const char *_str);
