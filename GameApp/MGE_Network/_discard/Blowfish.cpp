...
void Blowfish::Encrypt(unsigned long *xl, unsigned long *xr){
	unsigned long  Xl;
	unsigned long  Xr;
	unsigned long  temp;
	short       i;
...
void Blowfish::Decrypt(unsigned long *xl, unsigned long *xr){
	unsigned long  Xl;
	unsigned long  Xr;
	unsigned long  temp;
	short       i;
...
void Blowfish::Init(unsigned char *key, int keyLen) {
	int i, j, k;
...
void Blowfish::SwapEndian(unsigned long *src) {
...
void Blowfish::Encrypt(const void *buf, unsigned int llen) {
...
void Blowfish::Decrypt(const void *buf, unsigned int llen) {
	unsigned long *lbuf = (unsigned long *)buf;
	unsigned long *L = lbuf;
	unsigned long *R = lbuf;
